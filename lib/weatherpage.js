                ...
                <div class="maincontainer">
                    <div id="InputBox">
                        <form action="/search" method="get">
                            <input type="text" id="Weather_input" placeholder="Input the city name" size="40" name="placename" type="submit">
                            <button onclick="input_text()" id="Search_Button" type=""><i class="fas fa-search"></i>
                        </form>
                    </div>
                    <div class="weather">
